...
/***********************************************************************
** Function: smithyCard()
** Description: function to perform the smithy card function (draw 3)
** Input: currentPlayer, game state, and hand position
** Output: Returns 0 when the action has been completed
***********************************************************************/
...
** Description: function to perform the adventurer card function (You may 
** play this card as an action. You reveal cards from the top of your deck 
** until you have revealed two treasure cards. You then put those treasure 
** cards into your hand and discard the rest of the cards revealed this way.)
** Input: currentPlayer, game state
** Output: Returns 0 when the action has been completed
***********************************************************************/
...
/***********************************************************************
** Function: mineCard()
** Description: function to perform the mine card function (trash your 
** lessor currency (or treasures) to obtain a treasure of a higher value. 
** Turning copper into silver and silver into gold.)
** Input: currentPlayer, game state, hand position, choice 1, choice 2, choice 3
** Output: Returns 0 when the action has been completed or negative 1 
...
** Description: function to perform the village card function (You play 
** this card as an action. After this card is played you draw one card, 
** then are allotted one more action for your turn.)
** Input: currentPlayer, game state, and hand position
** Output: Returns 0 when the action has been completed
***********************************************************************/
...
** Description: function to perform the council room card function (You 
** first draw 4 cards and gain one buy for your turn. Next, the other 
** players are forced to draw one card.)
** Input: currentPlayer, game state, and hand position
** Output: Returns 0 when the action has been completed
***********************************************************************/
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  //uses switch to select card and perform actions
	...
	case mine:
		return mineCard(currentPlayer, state, handPos, choice1, choice2, choice3);
